...
type CalculatorClient interface {
	Add(ctx context.Context, in *Send, opts ...grpc.CallOption) (*Receive, error)
}
...
func (c *calculatorClient) Add(ctx context.Context, in *Send, opts ...grpc.CallOption) (*Receive, error) {
	out := new(Receive)
	err := c.cc.Invoke(ctx, "/MyCalculator.Calculator/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServer interface {
	Add(context.Context, *Send) (*Receive, error)
...
func (UnimplementedCalculatorServer) Add(context.Context, *Send) (*Receive, error) {
...
func _Calculator_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MyCalculator.Calculator/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Add(ctx, req.(*Send))
	}
...
var Calculator_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "MyCalculator.Calculator",
