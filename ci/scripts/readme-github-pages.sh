...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-frontend-and-backend-api-examples\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-frontend-and-backend-api-examples\/master\/svgs\//g' temp-README.md
echo " "
